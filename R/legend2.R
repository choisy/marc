...
#' legend2(97, 22.5 ,a ,heat.colors(6))
#'
...
#' # top left
#' a <- choropleth_map(dengue_0993, map)
#' legend2(a, heat.colors(6))
#' # top right
#' a <- choropleth_map(dengue_0993, map)
#' legend2(a, heat.colors(6), pos = "top-right")
#' # bottom left
#' a <- choropleth_map(dengue_0993, map)
#' legend2(a, heat.colors(6), pos = "bottom-left")
#' # bottom right
#' a <- choropleth_map(dengue_0993, map)
#' legend2(a, col = heat.colors(6), pos = "bottom-right")
#'
...
#' a <- choropleth_map(dengue_0993, map)
#' legend2(a, heat.colors(6), pos = "bottom-right",
#'          postext = "right")
#'
#' # Printing the color of the missing values:
#' a <- choropleth_map(dengue_0993, map)
#' legend2(a, heat.colors(6), col_na = "grey")
#'
#' # Changing the number of decimal:
#' a <- choropleth_map(dengue_0993, map,
#'                fixedBreaks = c(0, 0.5, 5, 50, 150, 550, 1300))
#' legend2(a, heat.colors(6), col_na = "grey", n_round = 1)
#'
#' # Changing the text parameters:
#' a <- choropleth_map(dengue_0993, map,
#'                fixedBreaks = c(0, 0.5, 5, 50, 150, 550, 1300))
#' legend2(a, heat.colors(6), col_na = "grey", n_round = 2,
#'          cex = 0.8)
#'
...
#' legend2(a, heat.colors(6), locate = TRUE)
#'}
#'
#' @importFrom magrittr %>%
#' @importFrom magrittr %<>%
